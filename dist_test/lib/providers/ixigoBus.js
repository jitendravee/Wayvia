...
import { resolveIxigoCity } from "./ixigo/cityResolve";
 ...
 */
function buildBusListRequest(src, dst, date) {
    return {
        source: src.label,
        sourceid: src.id,
