...
import { getLiveStations, getDiscoveredStations, looksLikeStation } from "./erail/stationDirectory";
/**
...
const STATIC_SEED = (() => {
    ...
    for (const s of EXTRA_STATIONS)
        byCode.set(s.code, s); // extra entries win — richer city names
...
export const ALL_STATIONS_STATIC = [...STATIC_SEED].sort((a, b) => a.name.localeCompare(b.name));
