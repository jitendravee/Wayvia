  ...
  return (
    ...
    >
      <div className="mx-auto flex items-center justify-between px-5 py-3.5 sm:px-6">
        ...
        <Link
          href="/pnr-status"
          className="rounded-full bg-black px-4 py-2 font-display text-[13px] font-semibold text-white! shadow-sm shadow-black/50 transition-colors hover:bg-violet-dark"
        >
          Check PNR
        </Link>
      </div>
